        ...
        public class FileBrowserCrumbRgn : FileBrowserArea
        {
            ...
            { 
                ...
                if (acceptText == true)
                {
                    ...
                    try
                    {
                        string directoryString = this.textInput.text;
                        directoryString = this.browser.TranslateStringDirectory(directoryString);
                        //
                        dir = new System.IO.DirectoryInfo(directoryString);
                    }
