        ...
        public class FileBrowseFileListRgn : FileBrowserArea
        {
            ...
            { 
                ...
                { 
                    ...
                    float textWidth = tg.GetPreferredWidth(fe.text.text, tgs) / fe.text.transform.lossyScale.x;
                    maxTextWidth = Mathf.Max(maxTextWidth, textWidth);
                    maxTextWidth = Mathf.Ceil(maxTextWidth) + 1.0f;
                }
                ...
                { 
                    ...
                    TextGenerator tg = fe.text.cachedTextGenerator;
                    float heightText = tg.GetPreferredHeight(fe.text.text, tgs) / fe.text.transform.localScale.y;
