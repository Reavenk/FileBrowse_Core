    ...
    namespace FileBrowse
    {
        public class FileBrowser : MonoBehaviour
        {
            ...
            private bool ViewDirectory(string directory, NavigationType type, bool addHistory, bool clearForward)
            {
                ...
                directory = this.TranslateStringDirectory(directory);
            ...
            public string TranslateStringDirectory(string strDir)
            { 
                string tolowerDir = strDir.ToLower().Trim();

                try
                {
                    // Not a comprehensive list, the exact feature set of translations 
                    // to support isn't well defined at the moment.
                    //
                    if(tolowerDir == "desktop")
                        return System.Environment.GetFolderPath(System.Environment.SpecialFolder.DesktopDirectory);
                    else if(tolowerDir == "music")
                        return System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyMusic);
                    else if(tolowerDir == "documents")
                        return System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
                    else if(tolowerDir == "user")
